...
int main(int argc, char *argv[])
{
    ...
    {
        printf("matrix-mult,parallel-non-tiled-loop-inter,%d,speed-up,%d,%d,mem-allocation-error\n", cores, n, m);
        return 1;
    }
    ...
    printf("matrix-mult,parallel-non-tiled-loop-inter,%d,speed-up,%d,%d,%d,%f\n", cores, n, m,0, time);
